...
exports.register = function(client_id, client_secret, userInfo, fn) {
  ...
  params.client_id = client_id;
  params.client_secret = client_secret;
  //NOTE: this points to old endpoint. new endpoint not working.
  // Also note, this works, but reports error as invalid parsing.
  _post('/accountapi/register?' + qs.stringify(params), userInfo, fn);
